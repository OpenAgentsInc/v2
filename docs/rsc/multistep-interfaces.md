...
1. A Server Action that calls and returns the result from the `streamUI` function
2. Tool(s) (sub-tasks necessary to complete your overall task)
3. React component(s) that should be rendered when the tool is called
4. A page to render your chatbot
